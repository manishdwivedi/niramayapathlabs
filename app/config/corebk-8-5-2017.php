<?php 
 /*production*/
	Configure::write('debug',0); 
        if($_SERVER['REMOTE_ADDR'] == '182.69.164.113')
            Configure::write('debug',0); 
 ...
 */
		...
		Configure::write('SiteSettings.siteUrl','https://www.niramayahealthcare.com/');
        /*
        ...
        Configure::write('DirectPay.success_url', 'https://www.niramayahealthcare.com/payment/success');
        Configure::write('DirectPay.failure_url', 'https://www.niramayahealthcare.com/payment/failure');
        ...
        Configure::write('RequestStatus',array(4=>'Sample Process',5=>'Sent to Lab',6=>'Report',8=>'Cancelled',9=>'closed'));
