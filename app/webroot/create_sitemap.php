...
//////////////////////////////////// Options ////////////////////////////////////
$url = "http://www.bennigans.com.au/"; //The Url of the site - the last '/' is needed
...
$ignore_files = array(
	'404.php','error.php','configuration.php','include.inc','test.php','css.php','cron_scheduler.php','create_sitemap.php'
);

//The script will not enter these folders
$ignore_folders = array(
	'test','icon','cgi-bin','awstatsicons','awstats-icon','js','css','styles','images','vendors','cake','tmp','webroot','config','tests','plugins','locale');

//The default priority for all pages - the priority of all pages will increase/decrease with respect to this.
$starting_priority = ($_REQUEST['starting_priority']) ? $_REQUEST['starting_priority'] : 1;
