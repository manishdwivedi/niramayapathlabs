...
if (_ie == true) {
  document.writeln('<OBJECT classid="clsid:8AD9C840-044E-11D1-B3E9-00805F499D93" WIDTH="250" HEIGHT="250" NAME="fileupload" codebase="https://java.sun.com/update/1.4.2/jinstall-1_4-windows-i586.cab#Version=1,4,0,0">');
}
  ...
  document.write('url="https://localhost:8443/upload/process.jsp" ');
  ...
  document.writeln('pluginspage="https://java.sun.com/products/plugin/index.html#download"><NOEMBED>');
  // END
}
else {
...
document.writeln('<PARAM NAME="url" VALUE="https://localhost:8443/upload/process.jsp">');
