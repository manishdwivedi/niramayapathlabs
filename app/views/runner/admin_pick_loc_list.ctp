...
<div class="contentcontainer">
    ...
    <?php echo $html->link('Home', '/admin/runner/pick_loc_list', array('title'=>'Home')); ?>&nbsp;&#187;&nbsp;Pickup Location List
	<div>&nbsp;</div>
	<?php echo $form->create(null, array('url'=>'/admin/runner/pick_loc_list')); ?>
	<table border="0">
		<thead>
			<tr>
	...
	<table border="0" width="100%">
		...
		if(isset($pick_locations) && count($pick_locations) > 0){
			$countTicket = count($pick_locations);
		...
		<tr <?php echo $class;?> style="background-color:<?php echo $status_color[$pick_locations[$ctr]['PickupLocations']['status']];?>">
			<td <?php echo $class;?> style="text-align:center;">
				<?php										
					echo ($ctr+1);
				?>
			</td>
			<td <?php echo $class;?>><?php echo $pick_locations[$ctr]['PickupLocations']['location_name'];?></td>
			<td <?php echo $class;?>><?php echo $pick_locations[$ctr]['PickupLocations']['poc'];?></td>
			<td <?php echo $class;?>><?php echo $pick_locations[$ctr]['PickupLocations']['contact'];?></td>
			<td <?php echo $class;?>><?php echo $pick_locations[$ctr]['PickupLocations']['pincode'];?></td>
			<td <?php echo $class;?> style="text-align:center;"><?php echo $html->link('Show',array('controller'=>'runner','action'=>'edit_pick_loc',base64_encode($pick_locations[$ctr]['PickupLocations']['id'])));?></td>
		</tr>
		<?php } ?>
		<tr>
