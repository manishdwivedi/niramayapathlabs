...
<div class="contentcontainer">
	...
	<?php echo $html->link('Home', '/admin/runner/route_list', array('title'=>'Home')); ?> &#187; Edit Route
	<?php }?>
	
	<?php echo $form->create(null, array('url'=>'/admin/runner/edit_route/'.base64_encode($this->data['Zone']['id']),'id'=>'form1','name'=>'form1')); ?>
		...
		<tr style="height: 40px;">
			...
			<td>
				<select id='data[Zone][time_of_day]' name='data[Zone][time_of_day]' style="width:323px;" required>
					...
					<option value="morning" <?php if($this->data['Zone']['time_of_day']=="morning") echo "selected"; ?>>Morning</option>
					<option value="evening" <?php if($this->data['Zone']['time_of_day']=="evening") echo "selected"; ?>>Evening</option>
				</select>
			</td>
		</tr>
		<tr style="height: 40px;">
