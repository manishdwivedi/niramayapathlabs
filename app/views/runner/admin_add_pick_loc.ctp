...
<div class="contentcontainer">
	<div class="headings altheading">
        <h2>Add New Pickup Location</h2>
    </div>
    <div class="contentbox">
	<?php echo $this->Session->flash(); ?>
	<?php if($usertype != 'Agent') {?>
	<?php echo $html->link('Home', '/admin/runner/add_pick_loc', array('title'=>'Home')); ?> &#187; Add New Pickup Location
	<?php }?>
	
	<?php echo $form->create(null, array('url'=>'/admin/runner/add_pick_loc','onsubmit'=>'return validationc(this);','id'=>'form1','name'=>'form1')); ?>
	...
	<table border="0" cellspacing="2" cellpadding="0" align="center" width="100%">
		...
		<tr style="height: 40px;">
			...
			<td>
				<?php echo $form->text('PickupLocations.location_name', array('class'=>'input-text','required')); ?>
			</td>
		</tr>
		<tr style="height: 40px;">
			<td width="15%" class="boldText">Routes<font color="#FF0000">*</font></td>
			<td>
				<?php echo $form->text('routes', array('class'=>'input-text observation')); ?>
				<br>
				<select id='routeList' multiple style="width:323px;margin-top: 20px;"></select><br><br>
		...
		<tr style="height: 40px;">
			...
			<td>
				<?php echo $form->text('PickupLocations.poc', array('class'=>'input-text','required')); ?>
			</td>
		</tr>
		<tr style="height: 40px;">
			<td width="15%" class="boldText">POC Contact<font color="#FF0000">*</font></td>
			<td>
				<?php echo $form->text('PickupLocations.contact', array('class'=>'input-text','maxlength'=>'10','onkeypress'=>'return checknum(event)','required'=>'required')); ?>
			</td>
		</tr>
		<tr style="height: 40px;">
			<td width="15%" class="boldText">Alternate Contact</td>
			<td>
				<?php echo $form->text('PickupLocations.alt_contact', array('class'=>'input-text','maxlength'=>'10','onkeypress'=>'return checknum(event)')); ?>
			</td>
		</tr>
		<tr style="height: 40px;">
			<td width="15%" class="boldText">Pincode<font color="#FF0000">*</font></td>
			<td>
				<?php echo $form->text('PickupLocations.pincode', array('class'=>'input-text','maxlength'=>'6','minlength'=>'6','onkeypress'=>'return checknum(event)','onkeyup'=>'getcitystate("PickupLocations");','required'=>'required')); ?>
		...
		<!--<tr>
			...
			<td>
				<select name="data[PickupLocations][locality]" id="PickupLocationsLocality" class="input-text" required>
				</select>
				<div id="msg9" style="color:#FF0000; font-size:12px;"></div>
			</td>	
		</tr>-->
		<tr>
			...
			<td>
				<?php echo $form->text('PickupLocations.address', array('class'=>'input-text','required')); ?>
			</td>
		</tr>
		<tr>
			<td width="15%" class="boldText">Landmark</td>
			<td>
				<?php echo $form->text('PickupLocations.landmark', array('class'=>'input-text')); ?>
			</td>
		</tr>
		<tr>
			<td width="15%" class="boldText">Google Location URL</td>
			<td>
				<?php echo $form->text('PickupLocations.geolocation', array('class'=>'input-text')); ?>
			</td>
		</tr>
