...
<div class="contentcontainer">
    ...
    <?php echo $html->link('Home', '/admin', array('title'=>'Home')); ?> &#187; <?php echo $html->link('Add Test', '/admin/tests/add_test', array('title'=>'Add Test')); ?> &#187; Add Speciality & Disease
...
<table border="0" cellspacing="2" cellpadding="0" align="center" width="100%">
	...
	<tr>
		<td colspan="2">Add Specialities & Diseases for <?php echo ucwords($testParam).' - '.$testCode;?></td>
	</tr>
	<tr>
		<td colspan="2">&nbsp;</td>
	</tr>
