...
<div class="contentcontainer">
    ...
    <?php echo $html->link('Home', '/admin', array('title'=>'Home')); ?> &#187; <?php echo $html->link('Manage Profile(s)', '/admin/tests/index', array('title'=>'Manage Profile(s)')); ?> &#187; <?php echo $html->link(ucwords($testParam), array('controller'=>'tests','action'=>'edit_test',base64_encode($dec_test_id)), array('title'=>ucwords($testParam))); ?> &#187; Edit Speciality & Disease
	<?php echo $form->create(null, array('url'=>'/admin/profiles/edit_spec_dise','id'=>'form1','name'=>'form1')); ?>
