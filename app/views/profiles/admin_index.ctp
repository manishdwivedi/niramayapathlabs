...
<table border="0" cellspacing="2" cellpadding="0" align="center" width="100%">
	...
	<tr <?php echo $class;?>>
		...
		<td <?php echo $class;?>><?php echo $profilelist[$ctr]['Test']['sequence'];?></td>
		...
		<td <?php echo $class;?> style="text-align:center;"><?php echo $profilelist[$ctr]['Test']['banner_market_mrp'];?></td>
