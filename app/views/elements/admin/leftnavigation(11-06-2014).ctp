...
<div id="leftside">
    	<div class="user">
			...
			?>
			<p>Logged in as:</p>
            <p class="username"><?php echo 'Super Admin';?></p>
			<?php
			}
			if($usertype == 'Agent') {
			?>
			<p>Logged in as:</p>
            <p class="username"><?php echo 'Helpdesk Admin';?></p>
			<?php 
			}
			...
			?>
			<p>Logged in as:</p>
            <p class="username"><?php echo 'Business Manager';?></p>
			<?php 
			}
			if($usertype == 'DA') 
			{
			?>
            <p>Logged in as:</p>
            <p class="username"><?php echo 'Doctor Admin';?></p>
			<?php }?>
