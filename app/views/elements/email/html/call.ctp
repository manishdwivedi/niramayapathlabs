...
<table width="600" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td width="20"></td>
    <td style="font:normal 12px/16px arial; text-align:justify;"><strong>Your Name -</strong> <?php echo $mailContent['Call']['name'];?></td>
    <td width="20"></td>
  </tr>
</table>
</td>
  ...
  <tr>
    <td style="font:bold 12px arial; padding:10px 0px 10px 20px;">Your Phone - <?php echo $mailContent['Call']['phone'];?></td>
  </tr>
  <tr>
    <td style="font:bold 12px arial; padding:10px 0px 10px 20px;">Your Message - <?php echo $mailContent['Call']['message'];?><br/></td>
  </tr>
