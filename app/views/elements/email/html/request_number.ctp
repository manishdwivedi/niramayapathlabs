...
<table width="600" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td style="font:bold 12px arial; padding:30px 0 10px 20px">Dear <?php echo $user_Name;?>,</td>
  </tr>
  <tr>
    <td>
	<table width="600" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td width="20"></td>
			<td style="font:normal 12px/16px arial;">Thank you for choosing nirAmaya Healthcare</td>
			<td width="20"></td>
		</tr>
		<tr>
			<td colspan="3">&nbsp;</td>
		...
		<tr>
			<td width="20"></td>
			<td style="font:normal 12px/16px arial;">Your Request No is: <?php echo $request_Number;?></td>
			<td width="20"></td>
		</tr>
		<tr>
			<td colspan="3">&nbsp;</td>
		...
		<tr>
    		<td width="20"></td>
    		<td style="font:normal 12px/16px arial; text-align:justify;">You can signing in using registered Emailid or Phone Number.<br /><span style="font-weight:bold;">Your Password is :</span> combination of the first alphabet of your name and last 4 digit of your mobile number.</td>
    		<td width="20"></td>
  		</tr>
	</table>
</td>
