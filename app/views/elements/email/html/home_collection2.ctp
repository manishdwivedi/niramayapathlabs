  ...
  <tr>
    ...
    <td style="font:normal 12px/16px arial; text-align:justify;">
		<table border="0" width="100%" cellpadding="0" cellspacing="0">
			...
			<?php if($mailContent['Health']['sample_date'] != '') {?>
			<tr>
			...
			<?php }?>
			<?php if($mailContent['Health']['sample_date1'] != '') {?>
			<tr>
			...
			<tr>
				...
				<td style="border-right:1px solid #D9D9D9; border-bottom:1px solid #D9D9D9; padding:10px;"><?php echo $mailContent['Health']['city_id'];?></td>
			</tr>
			<tr>
