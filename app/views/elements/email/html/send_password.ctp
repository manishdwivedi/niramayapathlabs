...
<table width="600" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td width="20"></td>
    <td style="font:normal 12px/16px arial; text-align:justify;">Your account is created at Menu Review and password is <b><?php echo $password;?></b>.</td>
    <td width="20"></td>
  </tr>
</table>
</td>
  ...
  <tr>
    <td style="font:bold 12px arial; padding:10px 0px 10px 20px;">Please login with your User name and Password after clicking on given link</td>
  </tr>
  <tr>
    <td style="font:bold 12px arial; padding:10px 0px 10px 20px;"><b><a href="http://projects.truelogictechnology.com/menureview/restaurants/login">Click Here</a></b></td>
  </tr>
  <tr>
    <td style="font:bold 12px arial; padding:10px 0px 10px 20px;">Thanks<br />
			Admin</td>
  </tr>
