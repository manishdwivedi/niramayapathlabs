...
<table cellspacing="0" cellpadding="0" border="1" width="650">
	<tr><td valign="top" colspan="4">
			<p><b>New Order has been placed for your restaurant . Details about the Customer is given as below :-</b> </p>
		</td></tr>
    <tr>
    	<td>Name</td><td><?php echo $data['Order']['first_name'];?> <?php echo $data['Order']['last_name'];?></td>
        <td>Address</td><td><?php echo $data['Order']['street_no'];?>, <?php echo $data['Order']['street_name'];?>, <?php echo $data['Order']['cross_street_name'];?></td>
     </tr>
    <tr>
    	<td>Delivery Time</td><td><?php if($data['Order']['time']=="now"){echo "Now";}else{echo $data['Order']['later_date'];echo " at "; echo $data['Order']['later_time'];}?></td>
        <td>Customer Email</td><td><?php echo $data['Order']['email'];?></td>
     </tr> 
    <tr>
    	<td>Contact Number(Mobile)</td><td><?php echo $data['Order']['mobile'];?></td>
    	
        <td>Contact Number(Land Line)</td><td><?php echo $data['Order']['phone'];?></td>
     </tr> 
      <tr>
        <td colspan="2">Company Name</td><td colspan="2"><?php echo $data['Order']['company_name'];?></td>
     </tr> 
     <tr><td colspan="4">Customer Comments</td></tr>
     <tr>
        <td colspan="4"><?php echo $data['Order']['comments'];?></td>
     </tr>   
