...
<table width="600" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td style="font:bold 12px arial; padding:30px 0 10px 20px"></td>
  </tr>
    <tr>
    <td><table width="600" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="20"></td>
    <td style="font:normal 12px/16px arial; text-align:justify;">You can signing in using registered Emailid or Phone Number</td>
    <td width="20"></td>
  </tr>
</table>
</td>
  ...
  <tr>
    <td style="font:bold 12px arial; padding:10px 0px 10px 20px;">Your New Password is :  <?php echo $user_pass;?></td>
  </tr>
