...
<table width="600" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td style="font:bold 12px arial; padding:30px 0 10px 20px">Dear <?php echo $user['Lab']['pcc_name'];?>, <br/><br/>
        Patient report attached of request id <?php echo $user['Billing']['order_id']; ?>
    </td>
  </tr>
