<div class="contentcontainer">
    ...
    <div class="contentbox">
		...
		<?php echo $html->link('Home', '/admin/observation/edit_observation', array('title'=>'Home')); ?>&nbsp;&#187;&nbsp;Edit Observation
		<div>&nbsp;</div>
		...
		<table border="0" width="100%">
			...
			<tr>
				...
				<td>
					<select id="selectmachine" name="data[Observation][machine]" class="input-Search" style="height:35px;width:200px;" required onchange="check(this);">
						...
						<option <?php echo ($this->data[Observation][machine] == $key) ? 'selected' : ''; ?> value="<?php echo $key;?>"><?php echo $val;?></option>
						<?php }?>
					</select>
				</td>
				<td>
			...
			<tr>
				...
				<td width="15%">
					<select id="selectgender" name="data[Observation][gender]" class="input-Search" style="height:35px;width:200px;" required>
						...
						<option <?php echo ($this->data[Observation][gender] == $key) ? 'selected' : ''; ?> value="<?php echo $key;?>"><?php echo $val;?></option>
						<?php }?>
					</select>
				</td>
			</tr>
			<tr>
				...
				<td>
					<select id="selectosinhouse" name="data[Observation][os_inhouse]" class="input-Search" style="height:35px;width:200px;" required onchange="check(this);">
						...
						<option <?php echo ($this->data[Observation][os_inhouse] == $key) ? 'selected' : ''; ?> value="<?php echo $key;?>"><?php echo $val;?></option>
						<?php }?>
					</select>
				</td>
				<td>
			...
			<tr>
				...
				<td>
					<select id="selectdepartment" name="data[Observation][department]" class="input-Search" style="height:35px;width:200px;" required onchange="check(this);">
						...
						<option <?php echo ($this->data[Observation][department] == $key) ? 'selected' : ''; ?> value="<?php echo $key;?>"><?php echo $val;?></option>
						<?php }?>
					</select>
				</td>
				<td>
			...
			<tr>
				...
				<td>
					<select id="selectsample" name="data[Observation][sample_type]" class="input-Search" style="height:35px;width:200px;" required>
						...
						<option <?php echo ($this->data[Observation][sample_type] == $key) ? 'selected' : ''; ?> value="<?php echo $key;?>"><?php echo $val;?></option>
						<?php }?>
					</select>
			...
			<tr>
				<td>&nbsp;<?php echo $form->text('Observation.observation_id', array('class'=>'input-text','style'=>'width:200px;display:none;')); ?></td>
