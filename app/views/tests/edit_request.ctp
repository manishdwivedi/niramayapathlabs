...
<script type="text/javascript" src="/Niramayahealthcare/js/jquery.js"></script>
<link rel="stylesheet" type="text/css" href="/Niramayahealthcare/css/jquery/ui-lightness/admin/jquery-ui.css" />

<script type="text/javascript" src="/Niramayahealthcare/js/jquery/jquery.ui.js"></script>
...
<div class="banner_res"><?php echo $this->Html->image('frontend/mobilebanner/niramaya_company-overview_static.jpg',array('alt'=>'nirAmaya Heathcare','title'=>'nirAmaya Heathcare'))?></div>
...
<?php echo $this->Session->flash(); ?>
    <div class="greenText">You have opted Test(s)/Profile(s)</div>
    <?php echo $form->create(null, array('url'=>SITE_URL.'tests/health_collection/'.$this->data['Health']['id'],'id'=>'form1','name'=>'form1','class'=>'bookForm','onsubmit'=>'return validationc(this);')); ?>
	<?php echo $form->hidden('Health.id',array('value'=>$this->data['Health']['id']));?>
    <div id="HomeCol"></div>
	<div style="float:right; padding:10px 0 0 0;"><a href="<?php echo SITE_URL;?>tests/book_for_self">Book Test for Self</a></div>
    <div class="boxRow"><label>Patient Name</label>
    <?php echo $form->text('Health.name',array('value'=>$find_req['Health']['name'],'onblur'=>'if(this.value=="")this.value="Please Enter Your name"',' onfocus'=>'if(this.value=="Please Enter Your name")this.value="";')); ?>
    <span id="msg1"></span>
    </div>
    ...
    <select name="data[Health][gender]" class="smallSelectBox" id="HealthGender">
		...
		<option value="<?php echo $val['Gender']['id'];?>" <?php if($find_req['Health']['gender'] == $val['Gender']['id']) {?> selected="selected" <?php }?>><?php echo $val['Gender']['name'];?></option>
		<?php }?>
	</select>  
    <label class="smalllabel">Patient Age</label>
    <?php echo $form->text('Health.age', array('class'=>'smallTextBox','value'=>$find_req['Health']['age'],'onblur'=>'if(this.value=="")this.value="Please Enter Your age"',' onfocus'=>'if(this.value=="Please Enter Your age")this.value="";')); ?>
    <span id="msg2"></span>
    <span id="msg3" style="margin-left:437px; margin-top: -14px;"></span>
    </div>
	<div class="boxRow"><label>Contact</label>
    <?php echo $form->text('Health.landline', array('value'=>$find_req['Health']['landline'],'onblur'=>'if(this.value=="")this.value="Please Enter Your mobile number"',' onfocus'=>'if(this.value=="Please Enter Your mobile number")this.value="";')); ?> 
	<span id="msg99"></span>
    </div>
    <div class="boxRow"><label>Remarks</label>
    <?php echo $form->textarea('Health.remarks', array('class'=>'textarea','value'=>$find_req['Health']['remarks'],'onblur'=>'if(this.value=="")this.value="Please enter your remarks"',' onfocus'=>'if(this.value=="Please enter your remarks")this.value="";','rows'=>5,'cols'=>30)); ?> 
    <span id="msg9"></span>
	</div>
	
	<div class="boxRow"><label>Refered By</label>
    <?php echo $form->text('Health.remark', array('class'=>'smallTextBox','value'=>$find_req['Health']['remark'],'onblur'=>'if(this.value=="")this.value="Please Enter Your Refferal"',' onfocus'=>'if(this.value=="Please Enter Your Refferal")this.value="";')); ?>
    <span id="msg8" style="margin-top: 30px; margin-left: -212px;"></span>
  </div>
   
   <div class="greenText01">Choose Sample collection Option</div>
   <div class="chooseDiv">
   <div class="optDiv marLeftNone"><input type="radio" name="opt" onclick="openQueBefore1();" id="visit" <?php if($find_req['Health']['city'] != '') {?> checked="checked" <?php }?>/><span>Visit a Lab</span></div>
   <div class="optDiv borderNone"><input type="radio" name="opt" onclick="showMail();" id="home" <?php if($find_req['Health']['city'] == '') {?> checked="checked" <?php }?>/><span>Home Collection</span></div>
   
   </div>
   
   <div class="formBox borderNone" id="firstQuestion" style=" <?php if($find_req['Health']['city'] == '') {?> display:block; <?php } else {?> display:none; <?php }?>">
   ...
   <?php echo $form->text('Health.sample_date1', array('class'=>'smallTextBox datepicker1','value'=>$find_req['Health']['sample_date1'],'onblur'=>'if(this.value=="")this.value="Please select a suitable date"',' onfocus'=>'if(this.value=="Please select a suitable date")this.value="";')); ?>
    <span id="msg9"></span>
	<span id="msg10" style="margin-left: 154px;"></span>
   	...
   	<?php 
	$expl_add = explode('*',$find_req['Health']['address']);
	?>
    <div class="boxRow">
    <label>Address</label>
    <?php echo $form->text('Health.address1', array('class'=>'smallTextBox','value'=>$expl_add[0],'onblur'=>'if(this.value=="")this.value="Please enter your residential address"',' onfocus'=>'if(this.value=="Please enter your residential address")this.value="";')); ?>
	...
	<div class="boxRow">
    <label>&nbsp;</label>
    <?php echo $form->text('Health.address2', array('class'=>'smallTextBox','value'=>$expl_add[1],'onblur'=>'if(this.value=="")this.value="Please enter your residential address"',' onfocus'=>'if(this.value=="Please enter your residential address")this.value="";')); ?>
    ...
    <?php echo $form->text('Health.locality', array('class'=>'smallTextBox','value'=>$find_req['Health']['locality'],'onblur'=>'if(this.value=="")this.value="Please enter locality"',' onfocus'=>'if(this.value=="Please enter locality")this.value="";')); ?>
    
	
	<label class="smalllabel">Pincode</label>
     <?php echo $form->text('Health.pincode', array('class'=>'smallTextBox','value'=>$find_req['Health']['pincode'],'onblur'=>'if(this.value=="")this.value="Please enter pincode"',' onfocus'=>'if(this.value=="Please enter pincode")this.value="";')); ?>
	 <span id="msg105"></span>
	<span id="msg106" style="margin-left: 208px;"></span>
    </div>
	<div class="boxRow">
    <label>Landmark</label>
    <?php echo $form->text('Health.landmark', array('class'=>'smallTextBox','value'=>$find_req['Health']['landmark'],'onblur'=>'if(this.value=="")this.value="Please enter your landmark"',' onfocus'=>'if(this.value=="Please enter your landmark")this.value="";')); ?>
    ...
    <!--<div class="boxRow"><img src="common/images/submit-button.gif" class="right" alt="Submit" /></div>-->
          ...
          <div id="beforeQue1" style=" <?php if($find_req['Health']['city'] != '') {?> display:block; <?php } else {?> display:none; <?php }?>">
           <div class="chooseDiv">
   ...
   <div class="optDiv <?php if($f%2 == 0) {?>borderNone<?php }else {?>marLeftNone<?php }?>"><input type="radio" name="data[Health][city]" id="HealthCityLab1" value="<?php echo $val['Lab']['id'];?>" <?php if($find_req['Health']['city'] == $val['Lab']['id']) {?> checked="checked" <?php }?>/><span><?php echo $val['Lab']['pcc_name'];?></span>
   <p class="addBoxIn"><?php echo nl2br($val['Lab']['pcc_address']);?></p>
   </div>
   <?php $f++;}?>        
   <!--<div class="optDiv marLeftNone"><input type="radio" name="data[Health][city]" id="HealthCityLab1" value="Crossing Republic" <?php //if($find_req['Health']['city'] == 'Crossing Republic') {?> checked="checked" <?php //}?>/><span>Crossing Republic</span>
   <p class="addBoxIn">Shop No. 08, LGF, Crossing Plaza,<br/>
Crossing Republic, Ghaziabad
</p>
   </div>
   <div class="optDiv borderNone"><input type="radio" name="data[Health][city]" id="HealthCityLab1" value="Indirapuram" <?php //if($find_req['Health']['city'] == 'Indirapuram') {?> checked="checked" <?php //}?>/><span>Indirapuram</span>
   <p class="addBoxIn">Shop No. 05 & 06, Lotus Plaza, Vaibahv Khand,<br/>
Indirapuram, Ghaziabad
</p>
   
   </div>
   <div class="optDiv marLeftNone"><input type="radio" name="data[Health][city]" id="HealthCityLab1" value="Noida" <?php //if($find_req['Health']['city'] == 'Noida') {?> checked="checked" <?php //}?>/><span>Noida patient care centre</span>
   ...
   <?php echo $form->input('Health.sample_time',array('type'=>'select','options'=>$time,'empty'=>'Please select a suitable time','class'=>'smallSelectBox','label'=>false)); ?>
    <label class="smalllabel">Date</label>
    <?php echo $form->text('Health.sample_date', array('class'=>'smallTextBox datepicker','value'=>$find_req['Health']['sample_date'],'onblur'=>'if(this.value=="")this.value="Please select a suitable date"',' onfocus'=>'if(this.value=="Please select a suitable date")this.value="";')); ?>
    <span id="msg12"></span>
