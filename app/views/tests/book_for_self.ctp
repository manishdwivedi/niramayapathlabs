...
<?php echo $this->Session->flash(); ?>
    ...
    <div id="HomeCol"></div>
	<div style="float:right;"><a href="<?php echo SITE_URL;?>tests/health_collection"><?php echo $html->image('frontend/book_test_for_other_button.jpg',array('style'=>'height:auto;width:139px;'));?></a></div>
    ...
    <?php echo $form->text('Health.age', array('class'=>'smallTextBox','value'=>$userData['User']['age'],'onblur'=>'if(this.value=="")this.value="Please Enter Your age"',' onfocus'=>'if(this.value=="Please Enter Your age")this.value="";')); ?>
    <span id="msg2"></span>
   ...
   <?php echo $form->input('Health.sample_time1',array('type'=>'select','options'=>$time1,'empty'=>'Please select a suitable time','class'=>'smallSelectBox','label'=>false)); ?>
	...
	<?php $explode_add = explode('*',$userData['User']['address']);?>
   	<div class="boxRow">
    <label>Address</label>
    <?php echo $form->text('Health.address1', array('class'=>'smallTextBox','value'=>$explode_add[0])); ?>
    
	
	<label class="smalllabel">City</label>
	<select name="data[Health][city_id]" id="HealthCityId" class="smallSelectBox">
	...
	<div class="boxRow">
    <label>&nbsp;</label>
    <?php echo $form->text('Health.address2', array('class'=>'smallTextBox','value'=>$explode_add[1])); ?>
    
	
	<label class="smalllabel">State</label>
    <select name="data[Health][state]" id="HealthState" class="smallSelectBox">
    ...
    <?php echo $form->text('Health.locality', array('class'=>'smallTextBox','value'=>$userData['User']['locality'])); ?>
    
	
	<label class="smalllabel">Pincode</label>
     <?php echo $form->text('Health.pincode', array('class'=>'smallTextBox','value'=>$userData['User']['pincode'])); ?>
	 <span id="msg105"></span>
	<span id="msg106" style="margin-left: 208px;"></span>
    </div>
	<div class="boxRow">
    <label>Landmark</label>
    <?php echo $form->text('Health.landmark', array('class'=>'smallTextBox','value'=>$userData['User']['landmark'])); ?>
    ...
    <!--<div class="boxRow"><img src="common/images/submit-button.gif" class="right" alt="Submit" /></div>-->
		  ...
		  .pcclisting .optDiv {
           ...
           <div class="chooseDiv pcclisting" style="width:1000px;">
                   
    <?php $f = 1; foreach($pcc as $key => $val) {?>        
   <div class="optDiv <?php if($f%4 == 0) {?>borderNone<?php }else {?>marLeftNone<?php }?>"><input type="radio" name="data[Health][city]" id="HealthCityLab1" value="<?php echo $val['Lab']['id'];?>"/><span><?php echo $val['Lab']['pcc_name'];?></span>
...
Indirapuram, Ghaziabad
   ...
   <span1 id="msg15" style="margin-left: 26px;"></span>-->
   </div>
