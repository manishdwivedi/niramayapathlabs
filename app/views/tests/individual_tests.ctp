...
*/
?>
<!-- Google Code for Niramaya Adwords Conversion Page -->
<script type="text/javascript">
/* <![CDATA[ */
var google_conversion_id = 986247220;
var google_conversion_language = "en";
var google_conversion_format = "3";
var google_conversion_color = "ffffff";
var google_conversion_label = "u_Y4CLu03GMQtOCj1gM";
...
<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/986247220/?value=1.00&amp;currency_code=INR&amp;label=u_Y4CLu03GMQtOCj1gM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
...
<div class="graynavigation">
  <ul>
     ...
     <li class="list"> <span> Individual Test</span></li>
  </ul>
</div>

<!--banner html-->
<div class="sliderOpening"> <img src="/img/covid/lab-tests.jpg" alt="Company Overview" class="scale"></div>
    ...
    <div class="greyBox">
      ...
      <div class="bot">
        <div class="ReportParameter">
          ...
          <p title="Name/Description"><i class="fa fa-info-circle" aria-hidden="true"></i><?php echo $testlisting[$ctr]['Test']['test_parameter'];?></p>
