...
<div class="contentcontainer">
	...
	<?php echo $form->create(null, array('url'=>'/admin/tests/edit_service','onsubmit'=>'return validationc(this);','id'=>'form1','name'=>'form1','enctype'=>'multipart/form-data')); ?>
...
<table border="0" cellspacing="2" cellpadding="0" align="center" width="100%">
	...
	<tr>
		...
		<td>
			<?php echo $form->textarea('Test.test_parameter', array('class'=>'class-textarea')); ?><span class="hint-class">(EX- Patient Care Nebulization Service)</span>
    ...
    <tr>
		...
		<td>
				<select name="data[Test][status]" required>
				<option value="">Select One</option>
				<option value="1" <?php if($this->data['Test']['status'] == '1') {?> selected="selected" <?php }?>>Active</option>
				<option value="2" <?php if($this->data['Test']['status'] == '2') {?> selected="selected" <?php }?>>Deactive</option>
			</select>
		</td>
	</tr>
	<tr>
