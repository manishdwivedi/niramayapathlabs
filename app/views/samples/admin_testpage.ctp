			...
			<tr>
				...
				<td>
					...
					<select name="data[Filter][req_status]" class="input-Search" style="width:100px;">
						...
						<option value="13">Sample Rescheduled</option>
					...
					<select name="data[Filter][req_status]" class="input-Search" style="width:100px;">
						...
						<option value="13" <?php if($data_req_request == 13) {?> selected="selected" <?php }?>>Sample Rescheduled</option>
					</select>
					<?php }?>
				</td>
				<td>
...
<table border="0" cellspacing="2" cellpadding="0" align="center" width="100%">
	...
	<?php } else {?>
		...
		<tr style="background-color:#feffab;" id="RequestId_<?php echo $samplerequestlist[$ctr]['Health']['id'];?>">
		<?php }?>
	...
	<!-- Code Edited By Ashish Ends-->	
		...
		<td style="text-align:center; border-bottom:1px solid #666666;">
			...
			<!--<a href="<?php echo PATIENT_REPORT_URL.$samplerequestlist[$ctr]['Health']['patient_report'];?>" target="_blank" style="color:#0066CC;">View</a>-->
                        ...
                        <?php if($userType == 'A' || $userType == 'BM'){ ?>
                            <a href="<?php echo SITE_URL;?>tests/view_report/<?php echo base64_encode($samplerequestlist[$ctr]['Health']['patient_report']);?>" target="_blank" onclick="window.alert('Balance Due - <?php
                            $amt_rec1 = ($samplerequestlist[$ctr]['Health']['total_amount']-$samplerequestlist[$ctr]['Health']['received_amount']);
                            echo $amt_rec1; ?>');">With Header</a>
                                    <a href="<?php echo SITE_URL;?>tests/print_report/<?php echo base64_encode($samplerequestlist[$ctr]['Health']['patient_report']);?>" target="_blank" onclick="window.alert('Balance Due - <?php
                            $amt_rec2 = ($samplerequestlist[$ctr]['Health']['total_amount']-$samplerequestlist[$ctr]['Health']['received_amount']);
                            echo $amt_rec2; ?>');">Without Header</a>
                        <?php } else { ?>
                            ...
                            { ?>
                                ...
                                <a href="javascript:void(0);" onclick="window.alert('Balance Due - <?php
                                echo $amt_rec1; ?>');">Without Header</a>
		...
		<td style="text-align:center; border-bottom:1px solid #666666;">
			<?php if($samplerequestlist[$ctr]['Health']['requ_status'] == 4) {?>
			<a href="<?php echo SITE_URL;?>admin/samples/view_detail/<?php echo base64_encode($samplerequestlist[$ctr]['Health']['id']);?>">Sample Process</a>
			<?php if(!empty($samplerequestlist[$ctr]['Health']['lab_message'])) {?>
			<?php echo $html->image('admin/envelope.jpg',array('width'=>'20','height'=>'10'));?>
			<?php }?>
			<?php }?>
			<?php if($samplerequestlist[$ctr]['Health']['requ_status'] == 5) {?>
			<a href="<?php echo SITE_URL;?>admin/samples/view_detail/<?php echo base64_encode($samplerequestlist[$ctr]['Health']['id']);?>">Sent to Lab</a>
			<?php if(!empty($samplerequestlist[$ctr]['Health']['lab_message'])) {?>
			<?php echo $html->image('admin/envelope.jpg',array('width'=>'20','height'=>'10'));?>
			<?php }?>
			<?php }?>
			<?php if($samplerequestlist[$ctr]['Health']['requ_status'] == 6) {?>
			<a href="<?php echo SITE_URL;?>admin/samples/view_detail/<?php echo base64_encode($samplerequestlist[$ctr]['Health']['id']);?>">Report</a>
			<?php if(!empty($samplerequestlist[$ctr]['Health']['lab_message'])) {?>
			<?php echo $html->image('admin/envelope.jpg',array('width'=>'20','height'=>'10'));?>
			<?php }?>
			<?php }?>
			<?php if($samplerequestlist[$ctr]['Health']['requ_status'] == 9) {?>
			<a href="<?php echo SITE_URL;?>admin/samples/view_detail/<?php echo base64_encode($samplerequestlist[$ctr]['Health']['id']);?>">Closed</a>
			<?php if(!empty($samplerequestlist[$ctr]['Health']['lab_message'])) {?>
			<?php echo $html->image('admin/envelope.jpg',array('width'=>'20','height'=>'10'));?>
			<?php }?>
			<?php }?>
			<?php if($samplerequestlist[$ctr]['Health']['requ_status'] == 7) {?>
			<a href="<?php echo SITE_URL;?>admin/samples/view_detail/<?php echo base64_encode($samplerequestlist[$ctr]['Health']['id']);?>">Partial Report</a>
			<?php if(!empty($samplerequestlist[$ctr]['Health']['lab_message'])) {?>
			<?php echo $html->image('admin/envelope.jpg',array('width'=>'20','height'=>'10'));?>
			<?php }?>
			<?php }?>
			...
			<a href="<?php echo SITE_URL;?>admin/samples/view_detail/<?php echo base64_encode($samplerequestlist[$ctr]['Health']['id']);?>">Test Cancelled</a>
			<?php }?>
			<?php if($samplerequestlist[$ctr]['Health']['requ_status'] == 10) {?>
			<a href="<?php echo SITE_URL;?>admin/samples/view_detail/<?php echo base64_encode($samplerequestlist[$ctr]['Health']['id']);?>">Sample Collected</a>
			<?php }?>
			<?php if($samplerequestlist[$ctr]['Health']['requ_status'] == 11) {?>
			<a href="<?php echo SITE_URL;?>admin/samples/view_detail/<?php echo base64_encode($samplerequestlist[$ctr]['Health']['id']);?>">Sample Rejected</a>
			<?php }?>
			<?php if($samplerequestlist[$ctr]['Health']['requ_status'] == 12) {?>
			<a href="<?php echo SITE_URL;?>admin/samples/view_detail/<?php echo base64_encode($samplerequestlist[$ctr]['Health']['id']);?>">Partial Sent To Lab</a>
			<?php }?>
			<?php if($samplerequestlist[$ctr]['Health']['requ_status'] == 13) {?>
			<a href="<?php echo SITE_URL;?>admin/samples/view_detail/<?php echo base64_encode($samplerequestlist[$ctr]['Health']['id']);?>">Sample Rescheduled</a>
			<?php }?>
			<!-- Code Edited By Ashish Ends-->
			...
			<a href="<?php echo SITE_URL;?>admin/samples/view_detail/<?php echo base64_encode($samplerequestlist[$ctr]['Health']['id']);?>">New booking</a>
