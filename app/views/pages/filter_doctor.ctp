<?php echo $javascript->link('price_slider/slides.min.jquery') ?>
...
function show_day(val)
{
	...
	if(curropen == '')
	{
		...
		$('#ClinicDetail_'+val).show();
		$('#PresentDay_'+val).show();
	}
	else
	{
		var getcurropen = document.getElementById('CurrOpen').innerHTML;
		document.getElementById('CurrOpen').innerHTML = val;
		$('#ClinicDetail_'+getcurropen).hide();
		$('#PresentDay_'+getcurropen).hide();
		$('#ClinicDetail_'+val).show();
		$('#PresentDay_'+val).show();
	}
}
...
<?php //if(!empty($search_name) && empty($search_speciality)  && empty($search_state)){?>
	//function alert_user()
//	{
...
//		window.location.href = siteUrl+'pages/login_page/find_doctor/<?php //echo $search_name;?>/novalue/novalue';
//	}
<?php //}?>
<?php //if(empty($search_name) && !empty($search_speciality)  && empty($search_state)) {?>
	//function alert_user()
//	{
//		alert('If you are an existing user then logged in your account after that book apppointment with doctor otherwise click on New User Signup link in login page and register yorself as a user.');
//		window.location.href = siteUrl+'pages/login_page/find_doctor/novalue/<?php //echo $search_speciality;?>/novalue';
//	}
<?php //}?>
<?php //if(empty($search_name) && empty($search_speciality)  && !empty($search_state)) {?>
	//function alert_user()
//	{
//		alert('If you are an existing user then logged in your account after that book apppointment with doctor otherwise click on New User Signup link in login page and register yorself as a user.');
//		window.location.href = siteUrl+'pages/login_page/find_doctor/novalue/novalue/<?php //echo $search_state;?>';
//	}
<?php //}?>
<?php //if(!empty($search_name) && !empty($search_speciality)  && empty($search_state)) {?>
	//function alert_user()
//	{
//		alert('If you are an existing user then logged in your account after that book apppointment with doctor otherwise click on New User Signup link in login page and register yorself as a user.');
//		window.location.href = siteUrl+'pages/login_page/find_doctor/<?php //echo $search_name;?>/<?php //echo $search_speciality;?>/novalue';
//	}
<?php //}?>
<?php //if(!empty($search_name) && empty($search_speciality)  && !empty($search_state)) {?>
	//function alert_user()
//	{
//		alert('If you are an existing user then logged in your account after that book apppointment with doctor otherwise click on New User Signup link in login page and register yorself as a user.');
//		window.location.href = siteUrl+'pages/login_page/find_doctor/<?php //echo $search_name;?>/novalue/<?php //echo $search_state;?>';
//	}
<?php //}?>
<?php //if(empty($search_name) && !empty($search_speciality)  && !empty($search_state)) {?>
	//function alert_user()
//	{
//		alert('If you are an existing user then logged in your account after that book apppointment with doctor otherwise click on New User Signup link in login page and register yorself as a user.');
//		window.location.href = siteUrl+'pages/login_page/find_doctor/novalue/<?php //echo $search_speciality;?>/<?php //echo $search_state;?>';
//	}
<?php //}?>
<?php //if(!empty($search_name) && !empty($search_speciality)  && !empty($search_state)) {?>
	//function alert_user()
//	{
//		alert('If you are an existing user then logged in your account after that book apppointment with doctor otherwise click on New User Signup link in login page and register yorself as a user.');
//		window.location.href = siteUrl+'pages/login_page/find_doctor/<?php //echo $search_name;?>/<?php //echo $search_speciality;?>/<?php //echo $search_state;?>';
//	}
<?php //}?>
</script>
<style type="text/css">
...
<?php //echo $javascript->link('price_slider/jquery.slider.min') ?>
<?php //echo $html->css('price_slider/jquery.slider.min');?>
<?php //echo $html->css('price_slider/bootstrap.min');?>
<?php 
...
?>
<?php if(!empty($filter_day_avail)) {?>
<div id="li-id" style="display:none;"><?php echo $filter_day_avail;?></div>
<?php } else {?>
...
<div id="bodyPart">
    <div class="bodyInnerDiv">
      ...
      <div class="findDoctorDiv">
		...
		<?php if(!empty($filter_day_avail)) {?>
		<div id="DayAvail" style="display:none;"><input type="hidden" name="data[Filter][day_avail]" value="<?php echo $filter_day_avail;?>" /></div>
		<?php } else {?>
        ...
        <div class="leftPanel">
          <div class="blockDiv marTopNone">
            ...
            <ul>
              <li>
                <input name="data[Filter][doctor_feature]" type="checkbox" value="1" <?php if($filter_feature == 1){?> checked="checked" <?php }?> />
          ...
          <!--<div class="blockDiv">
            ...
            <ul>
				<?php //foreach($get_state as $s_key => $s_val) {?>
              		<li><input name="data[Filter][state_name_<?php //echo $s_val['State']['id'];?>]" type="checkbox" value="<?php //echo $s_val['State']['id'];?>" /><span><?php //echo $s_val['State']['name'];?></span></li>
				<?php //}?>
				<li style="margin:15px 0 0 -7px;" id="ViewAll"><span><a href="javascript:void(0);" onclick="show_all();">View All</a></span></li>
				<div id="AllState" class="disNone">
				<?php //foreach($get_state_all as $alls_key => $alls_val) {?>
              		<li><input name="data[Filter][state_name_<?php //echo $alls_val['states']['id'];?>]" type="checkbox" value="<?php //echo $alls_val['states']['id'];?>" /><span><?php //echo $alls_val['states']['name'];?></span></li>
				<?php //}?>
				</div>
            </ul>
          </div>-->
          <div class="blockDiv">
            ...
            <div class="dateDiv">
              ...
              <ul>
              	<li <?php if($filter_day_avail == 1) {?> style="background-color:#68B323;" <?php }?> id="Li1"><a href="javascript:void(0);" onclick="day_avail(1);" <?php if($filter_day_avail == 1) {?> class="active" <?php }?> id="ach1">M</a></li>
                <li <?php if($filter_day_avail == 2) {?> style="background-color:#68B323;" <?php }?> id="Li2"><a href="javascript:void(0);" onclick="day_avail(2);" <?php if($filter_day_avail == 2) {?> class="active" <?php }?> id="ach2">T</a></li>
                <li <?php if($filter_day_avail == 3) {?> style="background-color:#68B323;" <?php }?> id="Li3"><a href="javascript:void(0);" onclick="day_avail(3);" <?php if($filter_day_avail == 3) {?> class="active" <?php }?> id="ach3">W</a></li>
                <li <?php if($filter_day_avail == 4) {?> style="background-color:#68B323;" <?php }?> id="Li4"><a href="javascript:void(0);" onclick="day_avail(4);" <?php if($filter_day_avail == 4) {?> class="active" <?php }?> id="ach4">T</a></li>
                <li <?php if($filter_day_avail == 5) {?> style="background-color:#68B323;" <?php }?> id="Li5"><a href="javascript:void(0);" onclick="day_avail(5);" <?php if($filter_day_avail == 5) {?> class="active" <?php }?> id="ach5">F</a></li>
                <li <?php if($filter_day_avail == 6) {?> style="background-color:#68B323;" <?php }?> id="Li6"><a href="javascript:void(0);" onclick="day_avail(6);" <?php if($filter_day_avail == 6) {?> class="active" <?php }?> id="ach6">S</a></li>
                <li <?php if($filter_day_avail == 7) {?> style="background-color:#68B323;" <?php }?> id="Li7"><a href="javascript:void(0);" onclick="day_avail(7);" <?php if($filter_day_avail == 7) {?> class="active" <?php }?> id="ach7">S</a></li>
          ...
          <div class="blockDiv">
            <div class="heading">
              ...
              <div class="time" style="font-weight:normal; font-size:12px; line-height:25px;">
				...
				<input type="text" name="data[Filter][cons_fee]" class="search-doctor-input" placeholder="eg.- 200" />-->
				<input type="radio" name="data[Filter][cons_fee]" value="100;500" <?php if($filter_fee == '100;500'){?> checked="checked" <?php }?> />&nbsp;&nbsp;Rs 100 - Rs 500<br />
				<input type="radio" name="data[Filter][cons_fee]" value="500;1000" <?php if($filter_fee == '500;1000'){?> checked="checked" <?php }?> />&nbsp;&nbsp;Rs 500 - Rs 1000<br />
				<input type="radio" name="data[Filter][cons_fee]" value="1000;1500" <?php if($filter_fee == '1000;1500'){?> checked="checked" <?php }?> />&nbsp;&nbsp;Rs 1000 - Rs 1500<br />
				<input type="radio" name="data[Filter][cons_fee]" value="1500;2000" <?php if($filter_fee == '1500;2000'){?> checked="checked" <?php }?> />&nbsp;&nbsp;Rs 1500 - Rs 2000<br />
			  </div>
              
         
          </div>
		   <div style="padding: 225px 0 0 8px;"><?php echo $form->submit('/img/change_index/filter-button.jpg',array('alt'=>'Filter','style'=>'cursor:pointer;'));?></div> 
        </div>
		<?php echo $form->end();?>
		...
		<div class="right-search-div">
			...
			<div class="search-div">
				...
				<?php echo $form->text('SearchDoctor.locality',array('placeholder'=>'Search by Clinic Name','class'=>'search-doctor-input','value'=>$search_city,'onkeyup'=>'get_city_val(this.value);','onclick'=>'get_city_val(this.value);'));?>
				...
				<?php } else {?>
				<?php echo $form->text('SearchDoctor.locality',array('placeholder'=>'Search by Clinic Name','class'=>'search-doctor-input','onkeyup'=>'get_city_val(this.value);','onclick'=>'get_city_val(this.value);'));?>
		...
		<?php if(count($search_doctor) > 0){$i = 1;foreach($search_doctor as $kk => $vv) { //echo "<pre>"; print_r($vv); exit;?>
		<script type="text/javascript">
		...
		<div class="doc-desc">
			<?php echo $form->create(null,array('url'=>'/pages/book_appointment_request_filter/'.$i,'id'=>'formrequest'.$i,'name'=>'formrequest'.$i));?>
			<?php echo $form->hidden('RequestAppointment.doctor_id',array('value'=>$vv['DoctorClinic']['doctor_id']));?>
			<?php echo $form->hidden('RequestAppointment.clinic_id',array('value'=>$vv['SearchedDoctor']['clinic_id']));?>
			
			<?php if(!empty($filter_feature) && $filter_feature != ''){?><?php echo $form->hidden('RequestAppointment.filter_feature'.$i,array('value'=>$filter_feature));?><?php }else{?><?php echo $form->hidden('RequestAppointment.filter_feature'.$i,array('value'=>'NO'));?><?php }?>
			<?php if(!empty($filter_day_avail) && $filter_day_avail != ''){?><?php echo $form->hidden('RequestAppointment.filter_day_avail'.$i,array('value'=>$filter_day_avail));?><?php }else{?><?php echo $form->hidden('RequestAppointment.filter_day_avail'.$i,array('value'=>'NO'));?><?php }?>
			<?php if(!empty($filter_fee) && $filter_fee != ''){?><?php echo $form->hidden('RequestAppointment.filter_fee'.$i,array('value'=>$filter_fee));?><?php }else{?><?php echo $form->hidden('RequestAppointment.filter_fee'.$i,array('value'=>'NO'));?><?php }?>
			<?php if(!empty($user_temp_id) && $user_temp_id != ''){?><?php echo $form->hidden('RequestAppointment.filter_user_temp'.$i,array('value'=>$user_temp_id));?><?php }else{?><?php echo $form->hidden('RequestAppointment.filter_user_temp'.$i,array('value'=>'NO'));?><?php }?>
		...
		<!--<div class="docDetailBox" id="ClinicDetail_<?php //echo $vv['DoctorClinic']['id'];?>" style="display:none;">
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td>
						<div class="left">
							<div class="cliName marTopNone"><div class="leftDiv">Clinic Name</div><div class="midDiv">:</div><div class="rightDiv"><?php //echo $vv['DoctorClinic']['clinic_name'];?></div></div>
							<div class="cliName"><div class="leftDiv">Clinic Address</div><div class="midDiv">:</div><div class="rightDiv"><?php //echo $vv['DoctorClinic']['clinic_add1'];?><br/><?php //echo $vv['DoctorClinic']['clinic_add2'];?></div></div>
						</div>
					</td>
					<?php //if($vv['DoctorClinic']['clinic_count'] > 1) {?>
					<td valign="bottom" width="239"><a href="<?php //echo SITE_URL;?>pages/doctor_detail/<?php //echo base64_encode($vv['DoctorClinic']['doctor_id']);?>"><?php //echo $html->image('change_index/book-appointment-on-other-clinic.jpg',array('alt'=>'Book Appointment On Other Clinic'));?></a></td>
					<?php //}?>
				</tr>
			</table>
		</div>-->
