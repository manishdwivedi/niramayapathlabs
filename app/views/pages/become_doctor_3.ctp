...
<div id="bodyPart">
  <div class="bodyInnerDiv">
    ...
    <?php }?>
    <?php echo $form->create(null, array('url'=>'/pages/become_doctor_3/'.$last_id.'/'.$real_pass,'id'=>'form2','name'=>'form2','onsubmit'=>'return validationc(this);','style'=>'width:100%;')); ?> 
	<?php echo $form->hidden('DoctorClinic.doctor_id',array('value'=>base64_decode($last_id)));?>
	<?php echo $form->hidden('DoctorClinic.doctor_id',array('value'=>base64_decode($last_id)));?>
	<h1>Clinic Information<span style="float:right;"><a href="<?php echo SITE_URL;?>pages/become_doctor_2/<?php echo $last_id;?>/<?php echo $real_pass;?>" style="color:#000000;">Back</a></span></h1>
    <div class="row">
