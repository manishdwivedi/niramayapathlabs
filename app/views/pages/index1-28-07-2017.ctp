...
the detection of specific lgM antibodies in humans</p>
			...
			<br>
              <div class="content-box2">
                ...
                <div class="content-right-box2">
                  <p>Include Dengue NS1 Antigen,lgG & lgM (for detection NS1 Antegen & antibodies produced by the body in response to a dengue fever infection, lgG and lgM)</p>
			...
			<br>
              <div class="content-box3">
                ...
                <div class="content-right-box3">
                  <p>Molecular PSR testing to test detects the genitic material of the Dengue & Chikungunya virus in the blood after symtoms appear(fever)</p>
