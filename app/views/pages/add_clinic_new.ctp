	...
	jQuery.ajax({
		...
		success:function(data){
			if(data.city_info.status == 'Success')
			{
				...
				rep_div +='<select name="data[DoctorClinic][city]">';
...
<div id="bodyPart">
  <div class="bodyInnerDiv">
    ...
    <h1>Add <span class="green">Clinic</span></h1>
    <div style="color:#FF0000; clear:both;">Fields in * are mandatory Fields</div>
    <?php echo $form->create(null, array('url'=>'/pages/add_clinic_new','id'=>'form2','name'=>'form2','onsubmit'=>'return validationc(this);')); ?> 
	<?php echo $form->hidden('DoctorClinic.doctor_id',array('value'=>$doctor_id));?>
