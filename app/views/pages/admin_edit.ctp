...
<?php echo $form->create('', array('url'=>'/admin/pages/edit/'.$id)); ?>
					...
					<div id="en">
						<table width="100%" cellpadding="0" cellspacing="0" border="0">
							<tr>
								...
								<td>
									<?php echo $form->text('Page.title1', array( 'class'=>'input-text','value'=>$this->data['pagelocales'][0]['title']));?>
									<?php 
							...
							<tr>
								...
								<td>
									<?php 
										echo $form->textarea('Page.content1',array('value'=>$this->data['pagelocales'][0]['content'])); 
