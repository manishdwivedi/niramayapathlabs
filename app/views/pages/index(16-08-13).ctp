 ...
 <div class="packagesInnerDiv">
      <div class="leftBox">
        <div class="innerDiv">
		  ...
		  <span style="float:right;"><a href="<?php SITE_URL?>tests/become_member" style="text-decoration:none; color:#000000;">Become a Member</a></span>
          ...
          <?php echo $form->create(null, array('url'=>'/pages/index/become_form','id'=>'form3','name'=>'form3','class'=>'marTopNone','onsubmit'=>'return validationcc(this);')); ?>
            ...
            <?php //echo $form->submit('', array('div'=>false, 'class' => 'rightBotton')); ?>
                    <?php echo $form->end();*/ ?>
            <p>Login with the details sent on your email while ordering Test/Profile.</p>
			...
			<span id="msg12"></span>
			<span style="float:left; padding:20px 0 0; color:#68B323; font-size:14px;"><?php echo $html->link('Forgot Password?',array('controller'=>'pages','action'=>'forg_pass'));?></span><input type="image" src="<?php SITE_URL?>img/frontend/submit-button.gif" class="rightBotton">
      ...
      <div class="rightPart">
        <div class="box">
		  ...
		  <h1>Search Test/Profile by Keyword</h1>
          <div class="testBox">
            <!--<div class="opt">
              <div class="heading">
			...
			<span style="float:left; padding:15px 19px 0 0; font-weight:bold;">Type Keyword</span>
			<?php echo $form->text('Search.test_search',array('class'=>'textBox-search'));?>
			<?php echo $form->submit('frontend/go_button.jpg',array('alt'=>'Go','style'=>'margin-top: 10px; margin-left: 15px;'));?>
			</div>
