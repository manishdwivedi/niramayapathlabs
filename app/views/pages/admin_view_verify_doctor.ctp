...
<div class="contentcontainer">
    <div class="headings altheading">
        <h2>Manage Verified Doctor(s)</h2>
    </div>
    <div class="contentbox">
			<?php echo $this->Session->flash(); ?>
    <?php echo $html->link('Home', '/admin', array('title'=>'Home')); ?>&nbsp;&#187;&nbsp;Manage Verified Doctor(s)
	<div>&nbsp;</div>
	<?php echo $form->create('Test', array('url'=>'/admin/pages/view_verify_doctor')); ?>
...
<table border="0" cellspacing="2" cellpadding="0" align="center" width="100%">
	...
	<tr>
		...
		<td style="text-align:center; border-bottom:1px solid #999999;"><?php echo $html->link('View Detail',array('controller'=>'pages','action'=>'doctor_detail_2',base64_encode($doctorlist[$ctr]['Doctor']['id'])));?></td>
	</tr>
	<?php }?>
