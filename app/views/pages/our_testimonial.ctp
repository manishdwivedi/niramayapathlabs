...
<div class="banner"><?php echo $this->Html->image('frontend/niramaya_testimonials.jpg',array('alt'=>'Banner'))?></div>
      </div>
    </div>
  </div>
  <!--Header:End--> 
    ...
    <div class="bodyInnerDiv">
      <div class="breadcrumbs">
        <div class="left">
          ...
          <div class="bread"><?php echo $this->Html->link('Our Testimonials','/pages/our_testimonial');?></div>
        </div>
...
<h2>OUR  <span class="green">TESTIMONIAL</span></h2>
