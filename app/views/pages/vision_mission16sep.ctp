...
<div class="banner"><?php echo $this->Html->image('frontend/niramaya_vision-mission-values.jpg',array('alt'=>'Banner'))?></div>
      </div>
    </div>
  </div>
  <!--Header:End--> 
    ...
    <div class="bodyInnerDiv">
      <div class="breadcrumbs">
        <div class="left">
          ...
          <div class="bread"><?php echo $this->Html->link('Vision Mission Values','/pages/vision_mission');?></div>
        </div>
