...
<div class="banner"><?php echo $this->Html->image('frontend/niramaya_privacy-policy.jpg',array('alt'=>'Banner'))?></div>
      </div>
    </div>
  </div>
  <!--Header:End--> 
    ...
    <div class="bodyInnerDiv">
      <div class="breadcrumbs">
        <div class="left">
          ...
          <div class="bread"><?php echo $this->Html->link('Privacy','/pages/privacy');?></div>
        </div>
