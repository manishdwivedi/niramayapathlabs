<div id="layout">
  ...
  <div id="bodyPart">
          ...
          <div class="form-region">
			...
			function show_tooltip(val)
			{
				...
				if(val == 1)
				{
                  ...
                  <span> <a class="color-on-link2" href="<?php SITE_URL?>tests/become_member">New User SignUp</a> <br>
            ...
            <div class="offer">
              <h3>Special Offers of the Month</h3>
              <div class="slider-fade-out">
                <ul id="demo1">
				<?php foreach($show_banner as $key => $val) {?>
				<li> <?php echo $this->Html->link($this->Html->image(OFFER_IMAGE_THUMB_URL.$val['Banner']['banner_image'], array('alt'=>'Banner')),'/tests/offers', array('escape' => false));?></li>
                  <?php }?>
                </ul>
              </div>
            </div>
    ...
    <section id="health_check">
      <div id="layout">
        <div class="checkup">
          <h1>Health Checkup today for a healthy tomorrow</h1>
          <div class="health-check-up-para">
            <p>nirAmaya Preventive Health Checkup packages are specially designed knowing the fact that not all diseases produce early warning signs 
              or symptoms. Our diagnosis is aimed to provide accurate and early detection of such diseases or deficiencies in your body and give 
              you an opportunity to proactively defend yourself against them in line with our philosophy</p>
            <?php echo $this->Html->image('blessing.png',array('alt'=>'blessing','title'=>'blessing'))?>
			</div>
          <div class="health-background">
            <div class="circle-div-text"><a href="http://www.niramayahealthcare.com/packagelists/package">FOR MORE DETAILS
              <h6>CLICK HERE</h6>
              </a></div>
			...
			<?php echo $this->Html->image('vital-health-checkup-img.png',array('alt'=>'vital health checkup','title'=>'vital health checkup','class'=>'fr'))?>
              ...
              <div class="content-box">
                <div class="content-left-box">
                  <h3>78 Tests</h3>
                  <h5>Worth Rs. 3000/- for </h5>
                  <h1>Rs. 1199/-</h1>
                </div>
                <div class="content-right-box">
                  <p>Check of Vital parameters & Vital organs like Heart, Liver, Kideny, Thyroid of your body<br />
                    & more.... </p>
                  <div class="button-health-chekup"><?php echo $this->Html->link('BOOK NOW','/tests/my_cart/10/package');?></div>
                </div>
              </div>
            </div>
			...
			<?php echo $this->Html->image('whole-body-health-checkup-img.png',array('alt'=>'whole-body-health-checkup','title'=>'whole-body-health-checkup','class'=>'fl'))?>
                ...
                <div class="content-left-box1">
                  <h3>97 Tests</h3>
                  <h5>Worth Rs. 6500/- for </h5>

                  <h1>Rs. 1999/-</h1>
                </div>
                <div class="content-right-box1">
                  <p> Complete vital Health Checkup along with Diabetes, HBA1c, Bone profile with RA Factor/ Ionized Calcium & more....</p>
                  <div class="button-health-chekup2"><?php echo $this->Html->link('BOOK NOW','/tests/my_cart/11/package');?></div>
                </div>
              </div>
            </div>
            <div class="box-first-item3">
              <div class="content-box2">
                <div class="content-left-box2">
                  <h3>99 Tests</h3>
                  <h5>Worth Rs. 8500/- for </h5>
                  <h1>Rs. 2999/-</h1>
                </div>
                <div class="content-right-box2">
                  <p> Complete body with all vital<br />
                    organs & parameters along with<br />
                    Diabetes, HBA1c, Vitamin D/B12,<br />
                    Bone profile with RA Factor/ Ionized<br />
                    Calcium & more....</p>
                  <div class="button-health-chekup3"><?php echo $this->Html->link('BOOK NOW','/tests/my_cart/12/package');?></div>
                </div>
              </div>
            ...
            <div class="box-first-item4">
              <div class="content-box3">
                <div class="content-left-box3">
                  <h3>103 Tests</h3>
                  <h5>Worth Rs. 12000/- for </h5>
                  <h1>Rs. 5999/-</h1>
                </div>
                <div class="content-right-box3">
                  <p>Comprehensive Checkup of Complete body with all vitals, Diabetes, Vitamins, Allergy, Infection & Cancer screening <br />
                    & more....</p>
                  <div class="button-health-chekup4"><?php echo $this->Html->link('BOOK NOW','/tests/my_cart/13/package');?></div>
                </div>
              </div>
    ...
    <section id="scrolling-text">
      <div class="scrolling-text-background">
        <div id="layout">
