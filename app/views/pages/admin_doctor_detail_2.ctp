...
<div class="contentcontainer">
    <div class="headings altheading">
        <h2>View Verified Doctor Details</h2>
    </div>
    <div class="contentbox">
			<?php echo $this->Session->flash(); ?>
    <?php echo $html->link('Home', '/admin', array('title'=>'Home')); ?> &#187; <?php echo $html->link('Manage Doctors(s)', '/admin/pages/view_verify_doctor', array('title'=>'View Verified Doctor')); ?> &#187; View Verified Doctor Details
...
<table border="0" cellspacing="2" cellpadding="0" align="center" width="100%">
	...
	<tr>
		<td colspan="2">
			<?php if( $get_doctor_detail['Doctor']['status'] == 1) {?>
			<?php echo $form->submit('Unverify Doctor', array('div'=>false, 'class' => 'btn','onclick'=>'unverify_doctor('.$get_doctor_detail['Doctor']['id'].');')); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<?php }?>
...
<script type="text/javascript">
function unverify_doctor(val)
{
	window.location.href=siteUrl+"admin/pages/unverify_doctor/"+val;
}
