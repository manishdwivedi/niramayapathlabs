<div id="layout">
  ...
  <div id="bodyPart">
      ...
      <div class="form-part-background">
        <div class="bodyInnerDiv">
          <div class="form-region">
            ...
            <div class="offer">
              <h3><!--Special Offers of the Month-->Our Centers</h3>
              <div class="slider-fade-out">
				...
				//for($i=1;$i<=8;$i++)
				{ ?>
				<li> <?php echo $this->Html->link($this->Html->image('contactmap/Map-1.jpg', array('alt'=>'Banner')),'/tests/offers', array('escape' => false));?></li>
				<li> <?php echo $this->Html->link($this->Html->image('contactmap/Map-2.jpg', array('alt'=>'Banner')),'/tests/offers', array('escape' => false));?></li>
				<li> <?php echo $this->Html->link($this->Html->image('contactmap/Map-3.jpg', array('alt'=>'Banner')),'/tests/offers', array('escape' => false));?></li>
				<li> <?php echo $this->Html->link($this->Html->image('contactmap/Map-4.jpg', array('alt'=>'Banner')),'/tests/offers', array('escape' => false));?></li>
				<li> <?php echo $this->Html->link($this->Html->image('contactmap/Map-5.jpg', array('alt'=>'Banner')),'/tests/offers', array('escape' => false));?></li>
				<li> <?php echo $this->Html->link($this->Html->image('contactmap/Map-6.jpg', array('alt'=>'Banner')),'/tests/offers', array('escape' => false));?></li>
				<li> <?php echo $this->Html->link($this->Html->image('contactmap/Map-7.jpg', array('alt'=>'Banner')),'/tests/offers', array('escape' => false));?></li>
				<li> <?php echo $this->Html->link($this->Html->image('contactmap/Map-8.jpg', array('alt'=>'Banner')),'/tests/offers', array('escape' => false));?></li>
                  <?php } ?>
                </ul>
              </div>
            </div>
    ...
    <section id="health_check">
      <div id="layout">
        <div class="checkup">
          <h1 style="color:#2aad0d;">This Monsoon Season protect Your family from deadly virues<br> 
& illnesses like Dengue, Chikungunya, Malaria without<br> Burning a big hole in your pocket</h1>
          ...
          <div class="health-background">
            <div class="circle-div-text">
					<?php echo $this->Html->image('circle-bg.png',array('alt'=>'','title'=>'','class'=>'fr'))?>
