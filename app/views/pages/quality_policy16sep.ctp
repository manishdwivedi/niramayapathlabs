...
<div class="banner"><?php echo $this->Html->image('frontend/niramaya_quality-policy.jpg',array('alt'=>'Banner'))?></div>
      </div>
    </div>
  </div>
  <!--Header:End--> 
    ...
    <div class="bodyInnerDiv">
      <div class="breadcrumbs">
        <div class="left">
          ...
          <div class="bread"><?php echo $this->Html->link('Quality Policy','/pages/quality_policy');?></div>
        </div>
        <div class="back right"><a href="<?php print $_SERVER['HTTP_REFERER'];?>">Back</a></div>
      </div>
<!--bodycontainer div start here-->

<h1>QUALITY <span class="green">POLICY</span></h1>
