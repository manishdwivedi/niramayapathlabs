...
function confirm_edit(val)
{
	alert('Please confirm to edit doctor personal details');
	window.location.href=siteUrl+"admin/pages/edit_personal_detail/"+val;
}
...
<div class="contentcontainer">
    ...
    <?php echo $html->link('Home', '/admin', array('title'=>'Home')); ?> &#187; <?php echo $html->link('Manage Doctors(s)', '/admin/pages/view_doctor', array('title'=>'View Doctor')); ?> &#187; View Doctor Details
...
<table border="0" cellspacing="2" cellpadding="0" align="center" width="100%">
	...
	<tr>
		<td colspan="2" style="text-align:right;"><a href="javascript:void(0);" onclick="confirm_edit('<?php echo base64_encode($get_doctor_detail['Doctor']['id']);?>');" style="color:#0099FF;">Edit Doctor Personal Details</a></td>
	</tr>
	<tr>
		<td colspan="2">
	...
	<tr>
		<td colspan="2">
			<?php if( $get_doctor_detail['Doctor']['status'] == 0) {?>
			<?php echo $form->submit('Verify Doctor', array('div'=>false, 'class' => 'btn','onclick'=>'verify_doctor('.$get_doctor_detail['Doctor']['id'].');')); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<?php }?>
			<?php if($get_doctor_detail['Doctor']['admin_featured'] == 0 && $get_doctor_detail['Doctor']['featured'] == 1) {?>
			<?php echo $form->submit('Confirm as a Featured Doctor', array('div'=>false, 'class' => 'btn','onclick'=>'feature_verify('.$get_doctor_detail['Doctor']['id'].');')); ?>
			<?php }?>
		</td>
	</tr>
	<?php //echo $form->end();?>
